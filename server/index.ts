...
import { signToken, hashPassword, comparePassword, verifyToken, requireAuth, sendJSON, setCORS, parseBody } from '../api/_lib/auth';
import { generateOTP, sendOTP } from '../api/_lib/sms';
